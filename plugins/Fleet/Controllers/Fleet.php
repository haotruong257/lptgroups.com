...
class Fleet extends Security_Controller
{
    ...
    public function maintenances_table()
    {
        if ($this->request->getPost()) {
            ...
            $result = data_tables_init($aColumns, $sIndexColumn, $sTable, $join, $where, [
                db_prefix() . 'fleet_maintenances.notes as notes',
                'supplier_id'
    ...
    public function logbook()
    {
        ...
        if ($data['id'] == '') {
            ...
            if ($success) {
                if ($data['driver_id'] != get_staff_user_id()) {
                    fleet_log_notification(
                        'fleet_logbook_assigned_to_you',
                        [
    ...
    public function inspection_failures_table()
    {
        ...
        $join         = [
            'LEFT JOIN ' . db_prefix() . 'fleet_inspection_question_box_description ON ' . db_prefix() . 'fleet_inspection_question_box_description.questionboxdescriptionid = ' . db_prefix() . 'fleet_inspection_results.boxdescriptionid',
    ...
    public function inspection_schedules_table()
    {
        if ($this->request->getPost()) {
            ...
            $result = data_tables_init($aColumns, $sIndexColumn, $sTable, $join, $where, [
                db_prefix() . 'fleet_inspections.vehicle_id as vehicle_id'
