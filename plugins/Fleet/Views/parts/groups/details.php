...
?>
<?php echo form_open(admin_url('fleet/part'.(isset($part) ? '/'.$part->id : '')), ['class' => 'part-form general-form', 'autocomplete' => 'off']); ?>

<h4><?php echo _l('identification'); ?></h4>
<?php $value = (isset($part) ? $part->name : ''); ?>
<?php echo render_input('name','name', $value, 'text', ['required' => true]); ?>

<?php $value = (isset($part) ? $part->part_type_id : ''); ?>
<?php echo render_select('part_type_id',$part_types, array('id', 'name'),'part_type',$value, ['required' => true]); ?>
...
<?php echo render_select('driver_id',$drivers, array('id', array('first_name', 'last_name')),'current_assignee',$value); ?>
...
<?php echo render_select('status', $status, array('id', 'name'), 'status',$value, ['required' => true]); ?>
