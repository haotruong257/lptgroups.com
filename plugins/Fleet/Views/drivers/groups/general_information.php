              ...
              <div class="text-center">
                <div class="userprofile">
                  <div class="userpic  brround mb-3">
                    <?php 
                    $image_url = get_avatar($driver->image);
                    $user_avatar = "<span class='avatar avatar-xs'><img src='$image_url' alt='...'></span>";

                    echo html_entity_decode($user_avatar); ?>
                  </div>
                  <h3 class="username mb-2"><?php echo new_html_entity_decode($driver->first_name . ' ' . $driver->last_name); ?></h3>
                </div>
              </div>
            </div>
            <br>
      ...
      <div class="card panel-theme">
        <div class="card-body no-padding">
          <ul class="list-group no-margin">
            ...
            <li class="list-group-item"><i class="fa fa-phone mr-4"></i> <?php echo new_html_entity_decode($driver->phone) ?></li>
        ...
        <div class="card-header">
          <div class="float-left">
            <br>
            <h4 class="card-title text-center"><?php echo _l('departments') ?></h4>
          </div>
...
foreach ($staff_departments as $staff_department) {
      ...
      if ($staff_department['id'] == $department['id']) {?>
                        <div class="chip-circle"><?php echo new_html_entity_decode($staff_department['title']); ?></div>
                      <?php }
    }
    ?>
                  <?php }?>
        ...
        <div class="card-header">
          <div class="float-left">
            <br>
            <h4 class="card-title text-left"><?php echo _l('hr_team_manage') . ':  ' . $user_avatar . '  ' . get_staff_full_name($driver->team_manage) ?></h4>
          </div>
          <div class="clearfix"></div>
        </div>
        ...
        <table class="table border table-striped ">
          <tbody>
            ...
            <tr class="project-overview">
              ...
              <td><?php echo new_html_entity_decode($driver->first_name . ' ' . $driver->last_name); ?></td>
            </tr>
            <tr class="project-overview">
            ...
            <tr class="project-overview">
              ...
              <td><?php echo new_html_entity_decode($driver->phone); ?></td>
            </tr>
            <tr class="project-overview">
