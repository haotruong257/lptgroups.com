<?php if(isset($driver)){ ?>
  <div class="page-title clearfix">
          <h1><?php echo _l('vehicle_assignments'); ?></h1>
          <div class="title-button-group">
           <div class="clearfix"></div>
                <a href="#" onclick="add_vehicle_assignment(); return false;" class="btn btn-default mbot15 <?php if(!fleet_has_permission('fleet_can_edit_driver') && !fleet_has_permission('fleet_can_edit_vehicle')){echo 'hide';} ?>"><span data-feather="plus-circle" class="icon-16"></span> <?php echo app_lang('add'); ?></a>
            </div>
          </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <?php echo render_select('driver_id',$drivers, array('id', array('first_name', 'last_name')),'driver', $driver->id, ['required' => true]); ?>
        <div class="row">
          <div class="col-md-6">
