...
<div class="card">
  ...
  <a href="#" class="btn btn-default add-new-insurance-category mbot15 <?php if(!fleet_has_permission('fleet_can_create_setting')){echo 'hide';} ?>"><i data-feather="plus-circle" class="icon-16"></i> <?php echo _l('add'); ?></a>
          </div>
    </div>
    <div class="card-body">
...
<div class="modal fade" id="insurance-category-modal">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <?php echo form_open_multipart(admin_url('fleet/insurance_category'),array('id'=>'insurance-category-form', 'class' => 'general-form'));?>
