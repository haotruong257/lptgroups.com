...
<div class="card">
  ...
  <a href="#" class="btn btn-default add-new-part-group mbot15 <?php if(!fleet_has_permission('fleet_can_create_setting')){echo 'hide';} ?>"><i data-feather="plus-circle" class="icon-16"></i> <?php echo _l('add'); ?></a>
          </div>
    </div>
    <div class="card-body">
<div class="row">
...
<div class="modal fade" id="part-group-modal">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <?php echo form_open_multipart(admin_url('fleet/part_group'),array('id'=>'part-group-form', 'class' => 'general-form'));?>
