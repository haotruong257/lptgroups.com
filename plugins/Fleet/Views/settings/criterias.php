...
<div class="card">
  ...
  <a href="#" class="btn btn-default add-new-criteria mbot15 <?php if(!fleet_has_permission('fleet_can_create_setting')){echo 'hide';} ?>"><i data-feather="plus-circle" class="icon-16"></i> <?php echo _l('add'); ?></a>
          </div>
    </div>
    <div class="card-body">
...
<div class="modal fade" id="criteria-modal">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <?php echo form_open_multipart(admin_url('fleet/criteria'),array('id'=>'criteria-form', 'class' => 'general-form'));?>
