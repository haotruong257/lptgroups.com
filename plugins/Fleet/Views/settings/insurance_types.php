...
<div class="card">
  ...
  <a href="#" class="btn btn-default add-new-insurance-type mbot15 <?php if(!fleet_has_permission('fleet_can_create_setting')){echo 'hide';} ?>"><i data-feather="plus-circle" class="icon-16"></i> <?php echo _l('add'); ?></a>
          </div>
    </div>
    <div class="card-body">
...
<div class="modal fade" id="insurance-type-modal">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <?php echo form_open_multipart(admin_url('fleet/insurance_type'),array('id'=>'insurance-type-form', 'class' => 'general-form'));?>
