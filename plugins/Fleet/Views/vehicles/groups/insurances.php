<div class="page-title clearfix">
 <h1><?php echo _l('insurances'); ?></h1>
 <div class="title-button-group">
  <div class="clearfix"></div>
       <a href="#" onclick="add_insurances(); return false;" class="btn btn-default mbot15 <?php if(!fleet_has_permission('fleet_can_create_insurance')){echo 'hide';} ?>"><span data-feather="plus-circle" class="icon-16"></span> <?php echo app_lang('add'); ?></a>
   </div>
 </div>
