    ...
    <div class="card">
        <div class="page-title clearfix">
          ...
          <div class="title-button-group">
              <a href="#" class="btn btn-default mbot15 add-new-booking"><span data-feather="plus-circle" class="icon-16"></span> <?php echo app_lang('add'); ?></a>
          </div>
          </div>
        <div class="card-body">
...
<div class="modal fade" id="booking-modal">
   <div class="modal-dialog modal-lg">
      <div class="modal-content">
         ...
         <?php echo form_open_multipart(admin_url('fleet_client/booking'),array('id'=>'booking-form', 'class' => 'general-form'));?>
         <?php echo form_hidden('id'); ?>
         <?php echo form_hidden('userid', get_client_user_id()); ?>
...
<?php require 'plugins/Fleet/assets/js/client/manage_js.php'; ?>
