...
(function($) {
  ...
  setDatePicker("#fuel_time");
  setDatePicker("#start_time");
  setDatePicker("#end_time");
  ...
  setDatePicker("#expiration_date");
    ...
    $('select[name="maintenance_type_filter"], input[name="from_date_filter"], input[name="to_date_filter"]').on('change', function(){
