...
register_installation_hook("Hr_profile", function () {
    require_once __DIR__ . '/install.php';
});

/* Active action */
register_activation_hook("Hr_profile", function () {
    require_once(__DIR__ . '/install.php');
});
...
app_hooks()->add_action('app_hook_hrrecord_init', function () {
    // No license check or logic needed
...
app_hooks()->add_action('app_hook_uninstall_plugin_Hr_profile', function () {
    ...
    // No license deactivation needed
});
