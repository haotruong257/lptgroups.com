...
<form method="POST" action="<?= base_url('/chi_tiet_phieu_cham_cong/create') ?>">
    <input type="hidden" name="id_phieu_cham_cong" value="1"> <!-- Giả định id_phieu_cham_cong là 1, có thể thay đổi động -->
                    ...
                    <tr>
                        ...
                        <?php for ($i = 1; $i <= 5; $i++): ?>
                            <td class="text-center">
                                <input type="radio" name="score[<?= $row['id'] ?>]" value="<?= $i ?>" required>
                            </td>
                        <?php endfor; ?>
                    </tr>
                <?php endforeach; ?>
