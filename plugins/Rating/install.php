...
$evaluationCriteria = [
    'Chuyên Cần Và Tác Phong' => [
        ['noiDung' => '<pre> Đi làm đúng giờ </pre><pre> - Được phép đi trễ tối đa 30p/tháng, không quá 10p/lần: không xin phép</pre><pre> - Được phép trễ tối đa 60p/tháng: Có xin duyệt</pre><pre>- Được phép về sớm tối đa 60p/tháng: Có xin duyệt </pre>', 'thuTuSapXep' => 1],
        ['noiDung' => '<pre> Đi làm đầy đủ: đủ công trên tháng, không nghỉ việc </pre><pre> riêng quá 01 ngày/tháng. (Tính trên check in-out)</pre> <pre>Trừ các trường hợp sau, khi nghỉ không ảnh hưởng</pre> <pre> Điểm chung:</pre> <pre>- Việc hiếu, hỷ theo Luật Lao Động.</pre><pre>- Bệnh có giấy Bệnh Viện</pre><pre>- Nghỉ phép năm</pre>', 'thuTuSapXep' => 2],
    ...
    'Chuyên Môn Hiệu Quả Công Việc Kỹ Năng Khác' => [
        ...
        ['noiDung' => '"<pre>Mức độ hoàn thành KPI được giao: 100%, 80%, 70%,…."
    "</pre><pre> ✓ 100% trở lên: Vượt chỉ tiêu, xuất sắc."
    "</pre><pre> ✓ <b>80% - 99%</b>: Đạt yêu cầu, hoàn thành tốt công việc."
    "</pre><pre> ✓ <b>50% - 79%</b>: Dưới mức mong đợi, cần cải thiện."
    "</pre><pre> ✓ <b>Dưới 50%</b>: Kém, chưa đáp ứng yêu cầu.</pre>"', 'thuTuSapXep' => 2],
